...
// Hackathon demo mode: keep the board awake while local websocket/audio testing is active.
// This prevents the sleep path from uninstalling I2S while a response is being played.
#define DEMO_DISABLE_SLEEP
